...
class uint8x4 {
   ...
   public:
    ...
    static uint8x4 cvt2vec(uint32_t rm) {
        return _mm_cvtsi32_si128(rm); /* MOVD xmm, r32 */
    }
    static uint32_t cvt2i32(uint8x4 a) {
        return _mm_cvtsi128_si32(a); /* MOVD r32, xmm */
    }
#elif USE_SIMD_ARM_NEON
    ...
    static uint32_t cvt2i32(uint8x4 a) {
        return vget_lane_u32(vreinterpret_u32_u8(a.v_), 0);
    }
#endif
};
