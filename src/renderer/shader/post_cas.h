...
const char *post_cas_glsl =
    ...
    "{"
    "return "
    "max(min(c*AF1_(4.5),AF1_(.018)),AF1_(1.099)*pow(c,AF1_(.45))-AF1_(.099));"
    "}"
    ...
    "return "
    "pow((AF1_(.835938)+AF1_(18.8516)*p)/"
    "(AF1_(1.)+AF1_(18.6875)*p),AF1_(78.8438));"
    "}"
    "AF1 AToSrgbF1(AF1 c)"
    "{"
    "return "
    "max(min(c*AF1_(12.92),AF1_(.0031308)),AF1_(1.055)*pow(c,AF1_(.41666))-AF1_"
    "(.055));"
    "}"
    "AF1 AToTwoF1(AF1 c)"
    "{"
    ...
    "{"
    "return "
    "max(min(c*AF1_(1./4.5),AF1_(.081)),pow((c+AF1_(.099))*(AF1_(1.)/"
    "AF1_(1.099)),AF1_(1./.45)));"
    "}"
    ...
    "return "
    "pow(ASatF1(p-AF1_(.835938))/"
    "(AF1_(18.8516)-AF1_(18.6875)*p),AF1_(6.27739));"
    "}"
    "AF1 AFromSrgbF1(AF1 c)"
    "{"
    "return "
    "max(min(c*AF1_(1./12.92),AF1_(.04045)),pow((c+AF1_(.055))*(AF1_(1.)/"
    "AF1_(1.055)),AF1_(2.4)));"
    "}"
    ...
    "{"
    "return "
    "max(min(c*AH2_(4.5),AH2_(.018)),AH2_(1.099)*pow(c,AH2_(.45))-AH2_(.099));"
    "}"
    ...
    "{"
    "return "
    "max(min(c*AH2_(12.92),AH2_(.0031308)),AH2_(1.055)*pow(c,AH2_(.41666))-AH2_"
    "(.055));"
    "}"
    "AH2 AToTwoH2(AH2 c)"
    "{"
    ...
    "{"
    "return "
    "max(min(c*AH2_(1./4.5),AH2_(.081)),pow((c+AH2_(.099))*(AH2_(1.)/"
    "AH2_(1.099)),AH2_(1./.45)));"
    "}"
    ...
    "{"
    "return "
    "max(min(c*AH2_(1./12.92),AH2_(.04045)),pow((c+AH2_(.055))*(AH2_(1.)/"
    "AH2_(1.055)),AH2_(2.4)));"
    "}"
    ...
    "{}\n"
    "#endif\n"
    "void CasFilter(out AF1 pixR,out AF1 pixG,out AF1 pixB,AU2 ip,AF4 "
    "const0,AF4 const1,AP1 noScaling)"
    "{"
    ...
    "ASU2 sp=ASU2(ip);"
    "AF3 "
    "a=CasLoad(sp+ASU2(-1,-1)),b=CasLoad(sp+ASU2(0,-1)),c=CasLoad(sp+ASU2(1,-1)"
    "),d=CasLoad(sp+ASU2(-1,0)),e=CasLoad(sp),f=CasLoad(sp+ASU2(1,0)),g="
    "CasLoad(sp+ASU2(-1,1)),h=CasLoad(sp+ASU2(0,1)),i=CasLoad(sp+ASU2(1,1));"
    ...
    "AF1 "
    "mnR=AMin3F1(AMin3F1(d.x,e.x,f.x),b.x,h.x),mnG=AMin3F1(AMin3F1(d.y,e.y,f.y)"
    ",b.y,h.y),mnB=AMin3F1(AMin3F1(d.z,e.z,f.z),b.z,h.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mnR2=AMin3F1(AMin3F1(mnR,a.x,c.x),g.x,i.x),mnG2=AMin3F1(AMin3F1(mnG,a.y,c."
    "y),g.y,i.y),mnB2=AMin3F1(AMin3F1(mnB,a.z,c.z),g.z,i.z);"
    "mnR=mnR+mnR2;"
    "mnG=mnG+mnG2;"
    "mnB=mnB+mnB2;"
    "\n#endif\n"
    "AF1 "
    "mxR=AMax3F1(AMax3F1(d.x,e.x,f.x),b.x,h.x),mxG=AMax3F1(AMax3F1(d.y,e.y,f.y)"
    ",b.y,h.y),mxB=AMax3F1(AMax3F1(d.z,e.z,f.z),b.z,h.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mxR2=AMax3F1(AMax3F1(mxR,a.x,c.x),g.x,i.x),mxG2=AMax3F1(AMax3F1(mxG,a.y,c."
    "y),g.y,i.y),mxB2=AMax3F1(AMax3F1(mxB,a.z,c.z),g.z,i.z);"
    "mxR=mxR+mxR2;"
    "mxG=mxG+mxG2;"
    "mxB=mxB+mxB2;"
    "\n#endif\n"
    ...
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "ampR=ASatF1(min(mnR,AF1_(2.)-mxR)*rcpMR),ampG=ASatF1(min(mnG,AF1_(2.)-mxG)"
    "*rcpMG),ampB=ASatF1(min(mnB,AF1_(2.)-mxB)*rcpMB);"
    "\n#else\n"
    "AF1 "
    "ampR=ASatF1(min(mnR,AF1_(1.)-mxR)*rcpMR),ampG=ASatF1(min(mnG,AF1_(1.)-mxG)"
    "*rcpMG),ampB=ASatF1(min(mnB,AF1_(1.)-mxB)*rcpMB);"
    "\n#endif\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "ampR=sqrt(ampR);"
    "ampG=sqrt(ampG);"
    ...
    "\n#ifdef CAS_GO_SLOWER\n"
    "AF1 "
    "rcpWeightR=ARcpF1(AF1_(1.)+AF1_(4.)*wR),rcpWeightG=ARcpF1(AF1_(1.)+AF1_(4."
    ")*wG),rcpWeightB=ARcpF1(AF1_(1.)+AF1_(4.)*wB);"
    "\n#else\n"
    "AF1 "
    "rcpWeightR=APrxMedRcpF1(AF1_(1.)+AF1_(4.)*wR),rcpWeightG=APrxMedRcpF1(AF1_"
    "(1.)+AF1_(4.)*wG),rcpWeightB=APrxMedRcpF1(AF1_(1.)+AF1_(4.)*wB);"
    "\n#endif\n"
    ...
    "ASU2 sp=ASU2(fp);"
    "AF3 "
    "a=CasLoad(sp+ASU2(-1,-1)),b=CasLoad(sp+ASU2(0,-1)),e=CasLoad(sp+ASU2(-1,0)"
    "),f=CasLoad(sp),c=CasLoad(sp+ASU2(1,-1)),d=CasLoad(sp+ASU2(2,-1)),g="
    "CasLoad(sp+ASU2(1,0)),h=CasLoad(sp+ASU2(2,0)),i=CasLoad(sp+ASU2(-1,1)),j="
    "CasLoad(sp+ASU2(0,1)),m=CasLoad(sp+ASU2(-1,2)),n=CasLoad(sp+ASU2(0,2)),k="
    "CasLoad(sp+ASU2(1,1)),l=CasLoad(sp+ASU2(2,1)),o=CasLoad(sp+ASU2(1,2)),p="
    "CasLoad(sp+ASU2(2,2));"
    "CasInput(a.x,a.y,a.z);"
    "CasInput(b.x,b.y,b.z);"
    "CasInput(c.x,c.y,c.z);"
    ...
    "AF1 "
    "mnfR=AMin3F1(AMin3F1(b.x,e.x,f.x),g.x,j.x),mnfG=AMin3F1(AMin3F1(b.y,e.y,f."
    "y),g.y,j.y),mnfB=AMin3F1(AMin3F1(b.z,e.z,f.z),g.z,j.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mnfR2=AMin3F1(AMin3F1(mnfR,a.x,c.x),i.x,k.x),mnfG2=AMin3F1(AMin3F1(mnfG,a."
    "y,c.y),i.y,k.y),mnfB2=AMin3F1(AMin3F1(mnfB,a.z,c.z),i.z,k.z);"
    "mnfR=mnfR+mnfR2;"
    "mnfG=mnfG+mnfG2;"
    "mnfB=mnfB+mnfB2;"
    "\n#endif\n"
    "AF1 "
    "mxfR=AMax3F1(AMax3F1(b.x,e.x,f.x),g.x,j.x),mxfG=AMax3F1(AMax3F1(b.y,e.y,f."
    "y),g.y,j.y),mxfB=AMax3F1(AMax3F1(b.z,e.z,f.z),g.z,j.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mxfR2=AMax3F1(AMax3F1(mxfR,a.x,c.x),i.x,k.x),mxfG2=AMax3F1(AMax3F1(mxfG,a."
    "y,c.y),i.y,k.y),mxfB2=AMax3F1(AMax3F1(mxfB,a.z,c.z),i.z,k.z);"
    "mxfR=mxfR+mxfR2;"
    "mxfG=mxfG+mxfG2;"
    "mxfB=mxfB+mxfB2;"
    "\n#endif\n"
    "AF1 "
    "mngR=AMin3F1(AMin3F1(c.x,f.x,g.x),h.x,k.x),mngG=AMin3F1(AMin3F1(c.y,f.y,g."
    "y),h.y,k.y),mngB=AMin3F1(AMin3F1(c.z,f.z,g.z),h.z,k.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mngR2=AMin3F1(AMin3F1(mngR,b.x,d.x),j.x,l.x),mngG2=AMin3F1(AMin3F1(mngG,b."
    "y,d.y),j.y,l.y),mngB2=AMin3F1(AMin3F1(mngB,b.z,d.z),j.z,l.z);"
    "mngR=mngR+mngR2;"
    "mngG=mngG+mngG2;"
    "mngB=mngB+mngB2;"
    "\n#endif\n"
    "AF1 "
    "mxgR=AMax3F1(AMax3F1(c.x,f.x,g.x),h.x,k.x),mxgG=AMax3F1(AMax3F1(c.y,f.y,g."
    "y),h.y,k.y),mxgB=AMax3F1(AMax3F1(c.z,f.z,g.z),h.z,k.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mxgR2=AMax3F1(AMax3F1(mxgR,b.x,d.x),j.x,l.x),mxgG2=AMax3F1(AMax3F1(mxgG,b."
    "y,d.y),j.y,l.y),mxgB2=AMax3F1(AMax3F1(mxgB,b.z,d.z),j.z,l.z);"
    "mxgR=mxgR+mxgR2;"
    "mxgG=mxgG+mxgG2;"
    "mxgB=mxgB+mxgB2;"
    "\n#endif\n"
    "AF1 "
    "mnjR=AMin3F1(AMin3F1(f.x,i.x,j.x),k.x,n.x),mnjG=AMin3F1(AMin3F1(f.y,i.y,j."
    "y),k.y,n.y),mnjB=AMin3F1(AMin3F1(f.z,i.z,j.z),k.z,n.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mnjR2=AMin3F1(AMin3F1(mnjR,e.x,g.x),m.x,o.x),mnjG2=AMin3F1(AMin3F1(mnjG,e."
    "y,g.y),m.y,o.y),mnjB2=AMin3F1(AMin3F1(mnjB,e.z,g.z),m.z,o.z);"
    "mnjR=mnjR+mnjR2;"
    "mnjG=mnjG+mnjG2;"
    "mnjB=mnjB+mnjB2;"
    "\n#endif\n"
    "AF1 "
    "mxjR=AMax3F1(AMax3F1(f.x,i.x,j.x),k.x,n.x),mxjG=AMax3F1(AMax3F1(f.y,i.y,j."
    "y),k.y,n.y),mxjB=AMax3F1(AMax3F1(f.z,i.z,j.z),k.z,n.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mxjR2=AMax3F1(AMax3F1(mxjR,e.x,g.x),m.x,o.x),mxjG2=AMax3F1(AMax3F1(mxjG,e."
    "y,g.y),m.y,o.y),mxjB2=AMax3F1(AMax3F1(mxjB,e.z,g.z),m.z,o.z);"
    "mxjR=mxjR+mxjR2;"
    "mxjG=mxjG+mxjG2;"
    "mxjB=mxjB+mxjB2;"
    "\n#endif\n"
    "AF1 "
    "mnkR=AMin3F1(AMin3F1(g.x,j.x,k.x),l.x,o.x),mnkG=AMin3F1(AMin3F1(g.y,j.y,k."
    "y),l.y,o.y),mnkB=AMin3F1(AMin3F1(g.z,j.z,k.z),l.z,o.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mnkR2=AMin3F1(AMin3F1(mnkR,f.x,h.x),n.x,p.x),mnkG2=AMin3F1(AMin3F1(mnkG,f."
    "y,h.y),n.y,p.y),mnkB2=AMin3F1(AMin3F1(mnkB,f.z,h.z),n.z,p.z);"
    "mnkR=mnkR+mnkR2;"
    "mnkG=mnkG+mnkG2;"
    "mnkB=mnkB+mnkB2;"
    "\n#endif\n"
    "AF1 "
    "mxkR=AMax3F1(AMax3F1(g.x,j.x,k.x),l.x,o.x),mxkG=AMax3F1(AMax3F1(g.y,j.y,k."
    "y),l.y,o.y),mxkB=AMax3F1(AMax3F1(g.z,j.z,k.z),l.z,o.z);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "mxkR2=AMax3F1(AMax3F1(mxkR,f.x,h.x),n.x,p.x),mxkG2=AMax3F1(AMax3F1(mxkG,f."
    "y,h.y),n.y,p.y),mxkB2=AMax3F1(AMax3F1(mxkB,f.z,h.z),n.z,p.z);"
    "mxkR=mxkR+mxkR2;"
    "mxkG=mxkG+mxkG2;"
    "mxkB=mxkB+mxkB2;"
    "\n#endif\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "AF1 "
    "rcpMfR=ARcpF1(mxfR),rcpMfG=ARcpF1(mxfG),rcpMfB=ARcpF1(mxfB),rcpMgR=ARcpF1("
    "mxgR),rcpMgG=ARcpF1(mxgG),rcpMgB=ARcpF1(mxgB),rcpMjR=ARcpF1(mxjR),rcpMjG="
    "ARcpF1(mxjG),rcpMjB=ARcpF1(mxjB),rcpMkR=ARcpF1(mxkR),rcpMkG=ARcpF1(mxkG),"
    "rcpMkB=ARcpF1(mxkB);"
    "\n#else\n"
    "AF1 "
    "rcpMfR=APrxLoRcpF1(mxfR),rcpMfG=APrxLoRcpF1(mxfG),rcpMfB=APrxLoRcpF1(mxfB)"
    ",rcpMgR=APrxLoRcpF1(mxgR),rcpMgG=APrxLoRcpF1(mxgG),rcpMgB=APrxLoRcpF1("
    "mxgB),rcpMjR=APrxLoRcpF1(mxjR),rcpMjG=APrxLoRcpF1(mxjG),rcpMjB="
    "APrxLoRcpF1(mxjB),rcpMkR=APrxLoRcpF1(mxkR),rcpMkG=APrxLoRcpF1(mxkG),"
    "rcpMkB=APrxLoRcpF1(mxkB);"
    "\n#endif\n"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AF1 "
    "ampfR=ASatF1(min(mnfR,AF1_(2.)-mxfR)*rcpMfR),ampfG=ASatF1(min(mnfG,AF1_(2."
    ")-mxfG)*rcpMfG),ampfB=ASatF1(min(mnfB,AF1_(2.)-mxfB)*rcpMfB),ampgR=ASatF1("
    "min(mngR,AF1_(2.)-mxgR)*rcpMgR),ampgG=ASatF1(min(mngG,AF1_(2.)-mxgG)*"
    "rcpMgG),ampgB=ASatF1(min(mngB,AF1_(2.)-mxgB)*rcpMgB),ampjR=ASatF1(min("
    "mnjR,AF1_(2.)-mxjR)*rcpMjR),ampjG=ASatF1(min(mnjG,AF1_(2.)-mxjG)*rcpMjG),"
    "ampjB=ASatF1(min(mnjB,AF1_(2.)-mxjB)*rcpMjB),ampkR=ASatF1(min(mnkR,AF1_(2."
    ")-mxkR)*rcpMkR),ampkG=ASatF1(min(mnkG,AF1_(2.)-mxkG)*rcpMkG),ampkB=ASatF1("
    "min(mnkB,AF1_(2.)-mxkB)*rcpMkB);"
    "\n#else\n"
    "AF1 "
    "ampfR=ASatF1(min(mnfR,AF1_(1.)-mxfR)*rcpMfR),ampfG=ASatF1(min(mnfG,AF1_(1."
    ")-mxfG)*rcpMfG),ampfB=ASatF1(min(mnfB,AF1_(1.)-mxfB)*rcpMfB),ampgR=ASatF1("
    "min(mngR,AF1_(1.)-mxgR)*rcpMgR),ampgG=ASatF1(min(mngG,AF1_(1.)-mxgG)*"
    "rcpMgG),ampgB=ASatF1(min(mngB,AF1_(1.)-mxgB)*rcpMgB),ampjR=ASatF1(min("
    "mnjR,AF1_(1.)-mxjR)*rcpMjR),ampjG=ASatF1(min(mnjG,AF1_(1.)-mxjG)*rcpMjG),"
    "ampjB=ASatF1(min(mnjB,AF1_(1.)-mxjB)*rcpMjB),ampkR=ASatF1(min(mnkR,AF1_(1."
    ")-mxkR)*rcpMkR),ampkG=ASatF1(min(mnkG,AF1_(1.)-mxkG)*rcpMkG),ampkB=ASatF1("
    "min(mnkB,AF1_(1.)-mxkB)*rcpMkB);"
    "\n#endif\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "ampfR=sqrt(ampfR);"
    "ampfG=sqrt(ampfG);"
    ...
    "\n#endif\n"
    "AF1 "
    "peak=const1.x,wfR=ampfR*peak,wfG=ampfG*peak,wfB=ampfB*peak,wgR=ampgR*peak,"
    "wgG=ampgG*peak,wgB=ampgB*peak,wjR=ampjR*peak,wjG=ampjG*peak,wjB=ampjB*"
    "peak,wkR=ampkR*peak,wkG=ampkG*peak,wkB=ampkB*peak,s=(AF1_(1.)-pp.x)*(AF1_("
    "1.)-pp.y),t=pp.x*(AF1_(1.)-pp.y),u=(AF1_(1.)-pp.x)*pp.y,v=pp.x*pp.y,thinB="
    "1./32.;"
    "\n#ifdef CAS_GO_SLOWER\n"
    ...
    "\n#endif\n"
    "AF1 "
    "qbeR=wfR*s,qbeG=wfG*s,qbeB=wfB*s,qchR=wgR*t,qchG=wgG*t,qchB=wgB*t,qfR=wgR*"
    "t+wjR*u+s,qfG=wgG*t+wjG*u+s,qfB=wgB*t+wjB*u+s,qgR=wfR*s+wkR*v+t,qgG=wfG*s+"
    "wkG*v+t,qgB=wfB*s+wkB*v+t,qjR=wfR*s+wkR*v+u,qjG=wfG*s+wkG*v+u,qjB=wfB*s+"
    "wkB*v+u,qkR=wgR*t+wjR*u+v,qkG=wgG*t+wjG*u+v,qkB=wgB*t+wjB*u+v,qinR=wjR*u,"
    "qinG=wjG*u,qinB=wjB*u,qloR=wkR*v,qloG=wkG*v,qloB=wkB*v;"
    "\n#ifndef CAS_SLOW\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "AF1 "
    "rcpWG=ARcpF1(AF1_(2.)*qbeG+AF1_(2.)*qchG+AF1_(2.)*qinG+AF1_(2.)*qloG+qfG+"
    "qgG+qjG+qkG);"
    "\n#else\n"
    "AF1 "
    "rcpWG=APrxMedRcpF1(AF1_(2.)*qbeG+AF1_(2.)*qchG+AF1_(2.)*qinG+AF1_(2.)*"
    "qloG+qfG+qgG+qjG+qkG);"
    "\n#endif\n"
    "pixR=ASatF1((b.x*qbeG+e.x*qbeG+c.x*qchG+h.x*qchG+i.x*qinG+n.x*qinG+l.x*"
    "qloG+o.x*qloG+f.x*qfG+g.x*qgG+j.x*qjG+k.x*qkG)*rcpWG);"
    "pixG=ASatF1((b.y*qbeG+e.y*qbeG+c.y*qchG+h.y*qchG+i.y*qinG+n.y*qinG+l.y*"
    "qloG+o.y*qloG+f.y*qfG+g.y*qgG+j.y*qjG+k.y*qkG)*rcpWG);"
    "pixB=ASatF1((b.z*qbeG+e.z*qbeG+c.z*qchG+h.z*qchG+i.z*qinG+n.z*qinG+l.z*"
    "qloG+o.z*qloG+f.z*qfG+g.z*qgG+j.z*qjG+k.z*qkG)*rcpWG);"
    "\n#else\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "AF1 "
    "rcpWR=ARcpF1(AF1_(2.)*qbeR+AF1_(2.)*qchR+AF1_(2.)*qinR+AF1_(2.)*qloR+qfR+"
    "qgR+qjR+qkR),rcpWG=ARcpF1(AF1_(2.)*qbeG+AF1_(2.)*qchG+AF1_(2.)*qinG+AF1_("
    "2.)*qloG+qfG+qgG+qjG+qkG),rcpWB=ARcpF1(AF1_(2.)*qbeB+AF1_(2.)*qchB+AF1_(2."
    ")*qinB+AF1_(2.)*qloB+qfB+qgB+qjB+qkB);"
    "\n#else\n"
    "AF1 "
    "rcpWR=APrxMedRcpF1(AF1_(2.)*qbeR+AF1_(2.)*qchR+AF1_(2.)*qinR+AF1_(2.)*"
    "qloR+qfR+qgR+qjR+qkR),rcpWG=APrxMedRcpF1(AF1_(2.)*qbeG+AF1_(2.)*qchG+AF1_("
    "2.)*qinG+AF1_(2.)*qloG+qfG+qgG+qjG+qkG),rcpWB=APrxMedRcpF1(AF1_(2.)*qbeB+"
    "AF1_(2.)*qchB+AF1_(2.)*qinB+AF1_(2.)*qloB+qfB+qgB+qjB+qkB);"
    "\n#endif\n"
    "pixR=ASatF1((b.x*qbeR+e.x*qbeR+c.x*qchR+h.x*qchR+i.x*qinR+n.x*qinR+l.x*"
    "qloR+o.x*qloR+f.x*qfR+g.x*qgR+j.x*qjR+k.x*qkR)*rcpWR);"
    "pixG=ASatF1((b.y*qbeG+e.y*qbeG+c.y*qchG+h.y*qchG+i.y*qinG+n.y*qinG+l.y*"
    "qloG+o.y*qloG+f.y*qfG+g.y*qgG+j.y*qjG+k.y*qkG)*rcpWG);"
    "pixB=ASatF1((b.z*qbeB+e.z*qbeB+c.z*qchB+h.z*qchB+i.z*qinB+n.z*qinB+l.z*"
    "qloB+o.z*qloB+f.z*qfB+g.z*qgB+j.z*qjB+k.z*qkB)*rcpWB);"
    "\n#endif\n"
    "}\n"
    "#endif\n"
    ...
    "}"
    "void CasFilterH(out AH2 pixR,out AH2 pixG,out AH2 pixB,AU2 ip,AU4 "
    "const0,AU4 const1,AP1 noScaling)"
    "{"
    "\n#ifdef CAS_DEBUG_CHECKER\n"
    "if(((ip.x^ip.y)>>8u&1u)==0u)"
    "{"
    ...
    "ASW2 sp0=ASW2(ip);"
    "AH3 "
    "a0=CasLoadH(sp0+ASW2(-1,-1)),b0=CasLoadH(sp0+ASW2(0,-1)),c0=CasLoadH(sp0+"
    "ASW2(1,-1)),d0=CasLoadH(sp0+ASW2(-1,0)),e0=CasLoadH(sp0),f0=CasLoadH(sp0+"
    "ASW2(1,0)),g0=CasLoadH(sp0+ASW2(-1,1)),h0=CasLoadH(sp0+ASW2(0,1)),i0="
    "CasLoadH(sp0+ASW2(1,1));"
    "ASW2 sp1=sp0+ASW2(8,0);"
    "AH3 "
    "a1=CasLoadH(sp1+ASW2(-1,-1)),b1=CasLoadH(sp1+ASW2(0,-1)),c1=CasLoadH(sp1+"
    "ASW2(1,-1)),d1=CasLoadH(sp1+ASW2(-1,0)),e1=CasLoadH(sp1),f1=CasLoadH(sp1+"
    "ASW2(1,0)),g1=CasLoadH(sp1+ASW2(-1,1)),h1=CasLoadH(sp1+ASW2(0,1)),i1="
    "CasLoadH(sp1+ASW2(1,1));"
    "AH2 "
    "aR=AH2(a0.x,a1.x),aG=AH2(a0.y,a1.y),aB=AH2(a0.z,a1.z),bR=AH2(b0.x,b1.x),"
    "bG=AH2(b0.y,b1.y),bB=AH2(b0.z,b1.z),cR=AH2(c0.x,c1.x),cG=AH2(c0.y,c1.y),"
    "cB=AH2(c0.z,c1.z),dR=AH2(d0.x,d1.x),dG=AH2(d0.y,d1.y),dB=AH2(d0.z,d1.z),"
    "eR=AH2(e0.x,e1.x),eG=AH2(e0.y,e1.y),eB=AH2(e0.z,e1.z),fR=AH2(f0.x,f1.x),"
    "fG=AH2(f0.y,f1.y),fB=AH2(f0.z,f1.z),gR=AH2(g0.x,g1.x),gG=AH2(g0.y,g1.y),"
    "gB=AH2(g0.z,g1.z),hR=AH2(h0.x,h1.x),hG=AH2(h0.y,h1.y),hB=AH2(h0.z,h1.z),"
    "iR=AH2(i0.x,i1.x),iG=AH2(i0.y,i1.y),iB=AH2(i0.z,i1.z);"
    "CasInputH(aR,aG,aB);"
    "CasInputH(bR,bG,bB);"
    "CasInputH(cR,cG,cB);"
    "CasInputH(dR,dG,dB);"
    ...
    "CasInputH(iR,iG,iB);"
    "AH2 "
    "mnR=min(min(fR,hR),min(min(bR,dR),eR)),mnG=min(min(fG,hG),min(min(bG,dG),"
    "eG)),mnB=min(min(fB,hB),min(min(bB,dB),eB));"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mnR2=min(min(gR,iR),min(min(aR,cR),mnR)),mnG2=min(min(gG,iG),min(min(aG,"
    "cG),mnG)),mnB2=min(min(gB,iB),min(min(aB,cB),mnB));"
    "mnR=mnR+mnR2;"
    "mnG=mnG+mnG2;"
    "mnB=mnB+mnB2;"
    "\n#endif\n"
    "AH2 "
    "mxR=max(max(fR,hR),max(max(bR,dR),eR)),mxG=max(max(fG,hG),max(max(bG,dG),"
    "eG)),mxB=max(max(fB,hB),max(max(bB,dB),eB));"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mxR2=max(max(gR,iR),max(max(aR,cR),mxR)),mxG2=max(max(gG,iG),max(max(aG,"
    "cG),mxG)),mxB2=max(max(gB,iB),max(max(aB,cB),mxB));"
    "mxR=mxR+mxR2;"
    "mxG=mxG+mxG2;"
    "mxB=mxB+mxB2;"
    "\n#endif\n"
    ...
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "ampR=ASatH2(min(mnR,AH2_(2.)-mxR)*rcpMR),ampG=ASatH2(min(mnG,AH2_(2.)-mxG)"
    "*rcpMG),ampB=ASatH2(min(mnB,AH2_(2.)-mxB)*rcpMB);"
    "\n#else\n"
    "AH2 "
    "ampR=ASatH2(min(mnR,AH2_(1.)-mxR)*rcpMR),ampG=ASatH2(min(mnG,AH2_(1.)-mxG)"
    "*rcpMG),ampB=ASatH2(min(mnB,AH2_(1.)-mxB)*rcpMB);"
    "\n#endif\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "ampR=sqrt(ampR);"
    "ampG=sqrt(ampG);"
    ...
    "\n#ifdef CAS_GO_SLOWER\n"
    "AH2 "
    "rcpWeightR=ARcpH2(AH2_(1.)+AH2_(4.)*wR),rcpWeightG=ARcpH2(AH2_(1.)+AH2_(4."
    ")*wG),rcpWeightB=ARcpH2(AH2_(1.)+AH2_(4.)*wB);"
    "\n#else\n"
    "AH2 "
    "rcpWeightR=APrxMedRcpH2(AH2_(1.)+AH2_(4.)*wR),rcpWeightG=APrxMedRcpH2(AH2_"
    "(1.)+AH2_(4.)*wG),rcpWeightB=APrxMedRcpH2(AH2_(1.)+AH2_(4.)*wB);"
    "\n#endif\n"
    ...
    "ASW2 sp0=ASW2(fp0);"
    "AH3 "
    "a0=CasLoadH(sp0+ASW2(-1,-1)),b0=CasLoadH(sp0+ASW2(0,-1)),e0=CasLoadH(sp0+"
    "ASW2(-1,0)),f0=CasLoadH(sp0),c0=CasLoadH(sp0+ASW2(1,-1)),d0=CasLoadH(sp0+"
    "ASW2(2,-1)),g0=CasLoadH(sp0+ASW2(1,0)),h0=CasLoadH(sp0+ASW2(2,0)),i0="
    "CasLoadH(sp0+ASW2(-1,1)),j0=CasLoadH(sp0+ASW2(0,1)),m0=CasLoadH(sp0+ASW2(-"
    "1,2)),n0=CasLoadH(sp0+ASW2(0,2)),k0=CasLoadH(sp0+ASW2(1,1)),l0=CasLoadH("
    "sp0+ASW2(2,1)),o0=CasLoadH(sp0+ASW2(1,2)),p0=CasLoadH(sp0+ASW2(2,2));"
    "AF1 pp1=pp.x+AF1_AU1(const1.z),fp1=floor(pp1);"
    "ppX.y=AH1(pp1-fp1);"
    "ASW2 sp1=ASW2(fp1,sp0.y);"
    "AH3 "
    "a1=CasLoadH(sp1+ASW2(-1,-1)),b1=CasLoadH(sp1+ASW2(0,-1)),e1=CasLoadH(sp1+"
    "ASW2(-1,0)),f1=CasLoadH(sp1),c1=CasLoadH(sp1+ASW2(1,-1)),d1=CasLoadH(sp1+"
    "ASW2(2,-1)),g1=CasLoadH(sp1+ASW2(1,0)),h1=CasLoadH(sp1+ASW2(2,0)),i1="
    "CasLoadH(sp1+ASW2(-1,1)),j1=CasLoadH(sp1+ASW2(0,1)),m1=CasLoadH(sp1+ASW2(-"
    "1,2)),n1=CasLoadH(sp1+ASW2(0,2)),k1=CasLoadH(sp1+ASW2(1,1)),l1=CasLoadH("
    "sp1+ASW2(2,1)),o1=CasLoadH(sp1+ASW2(1,2)),p1=CasLoadH(sp1+ASW2(2,2));"
    "AH2 "
    "aR=AH2(a0.x,a1.x),aG=AH2(a0.y,a1.y),aB=AH2(a0.z,a1.z),bR=AH2(b0.x,b1.x),"
    "bG=AH2(b0.y,b1.y),bB=AH2(b0.z,b1.z),cR=AH2(c0.x,c1.x),cG=AH2(c0.y,c1.y),"
    "cB=AH2(c0.z,c1.z),dR=AH2(d0.x,d1.x),dG=AH2(d0.y,d1.y),dB=AH2(d0.z,d1.z),"
    ...
    "fG=AH2(f0.y,f1.y),fB=AH2(f0.z,f1.z),gR=AH2(g0.x,g1.x),gG=AH2(g0.y,g1.y),"
    "gB=AH2(g0.z,g1.z),hR=AH2(h0.x,h1.x),hG=AH2(h0.y,h1.y),hB=AH2(h0.z,h1.z),"
    "iR=AH2(i0.x,i1.x),iG=AH2(i0.y,i1.y),iB=AH2(i0.z,i1.z),jR=AH2(j0.x,j1.x),"
    "jG=AH2(j0.y,j1.y),jB=AH2(j0.z,j1.z),kR=AH2(k0.x,k1.x),kG=AH2(k0.y,k1.y),"
    "kB=AH2(k0.z,k1.z),lR=AH2(l0.x,l1.x),lG=AH2(l0.y,l1.y),lB=AH2(l0.z,l1.z),"
    "mR=AH2(m0.x,m1.x),mG=AH2(m0.y,m1.y),mB=AH2(m0.z,m1.z),nR=AH2(n0.x,n1.x),"
    "nG=AH2(n0.y,n1.y),nB=AH2(n0.z,n1.z),oR=AH2(o0.x,o1.x),oG=AH2(o0.y,o1.y),"
    "oB=AH2(o0.z,o1.z),pR=AH2(p0.x,p1.x),pG=AH2(p0.y,p1.y),pB=AH2(p0.z,p1.z);"
    "CasInputH(aR,aG,aB);"
    "CasInputH(bR,bG,bB);"
    "CasInputH(cR,cG,cB);"
    "CasInputH(dR,dG,dB);"
    ...
    "CasInputH(pR,pG,pB);"
    "AH2 "
    "mnfR=AMin3H2(AMin3H2(bR,eR,fR),gR,jR),mnfG=AMin3H2(AMin3H2(bG,eG,fG),gG,"
    "jG),mnfB=AMin3H2(AMin3H2(bB,eB,fB),gB,jB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mnfR2=AMin3H2(AMin3H2(mnfR,aR,cR),iR,kR),mnfG2=AMin3H2(AMin3H2(mnfG,aG,cG)"
    ",iG,kG),mnfB2=AMin3H2(AMin3H2(mnfB,aB,cB),iB,kB);"
    "mnfR=mnfR+mnfR2;"
    "mnfG=mnfG+mnfG2;"
    "mnfB=mnfB+mnfB2;"
    "\n#endif\n"
    "AH2 "
    "mxfR=AMax3H2(AMax3H2(bR,eR,fR),gR,jR),mxfG=AMax3H2(AMax3H2(bG,eG,fG),gG,"
    "jG),mxfB=AMax3H2(AMax3H2(bB,eB,fB),gB,jB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mxfR2=AMax3H2(AMax3H2(mxfR,aR,cR),iR,kR),mxfG2=AMax3H2(AMax3H2(mxfG,aG,cG)"
    ",iG,kG),mxfB2=AMax3H2(AMax3H2(mxfB,aB,cB),iB,kB);"
    "mxfR=mxfR+mxfR2;"
    "mxfG=mxfG+mxfG2;"
    "mxfB=mxfB+mxfB2;"
    "\n#endif\n"
    "AH2 "
    "mngR=AMin3H2(AMin3H2(cR,fR,gR),hR,kR),mngG=AMin3H2(AMin3H2(cG,fG,gG),hG,"
    "kG),mngB=AMin3H2(AMin3H2(cB,fB,gB),hB,kB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mngR2=AMin3H2(AMin3H2(mngR,bR,dR),jR,lR),mngG2=AMin3H2(AMin3H2(mngG,bG,dG)"
    ",jG,lG),mngB2=AMin3H2(AMin3H2(mngB,bB,dB),jB,lB);"
    "mngR=mngR+mngR2;"
    "mngG=mngG+mngG2;"
    "mngB=mngB+mngB2;"
    "\n#endif\n"
    "AH2 "
    "mxgR=AMax3H2(AMax3H2(cR,fR,gR),hR,kR),mxgG=AMax3H2(AMax3H2(cG,fG,gG),hG,"
    "kG),mxgB=AMax3H2(AMax3H2(cB,fB,gB),hB,kB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mxgR2=AMax3H2(AMax3H2(mxgR,bR,dR),jR,lR),mxgG2=AMax3H2(AMax3H2(mxgG,bG,dG)"
    ",jG,lG),mxgB2=AMax3H2(AMax3H2(mxgB,bB,dB),jB,lB);"
    "mxgR=mxgR+mxgR2;"
    "mxgG=mxgG+mxgG2;"
    "mxgB=mxgB+mxgB2;"
    "\n#endif\n"
    "AH2 "
    "mnjR=AMin3H2(AMin3H2(fR,iR,jR),kR,nR),mnjG=AMin3H2(AMin3H2(fG,iG,jG),kG,"
    "nG),mnjB=AMin3H2(AMin3H2(fB,iB,jB),kB,nB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mnjR2=AMin3H2(AMin3H2(mnjR,eR,gR),mR,oR),mnjG2=AMin3H2(AMin3H2(mnjG,eG,gG)"
    ",mG,oG),mnjB2=AMin3H2(AMin3H2(mnjB,eB,gB),mB,oB);"
    "mnjR=mnjR+mnjR2;"
    "mnjG=mnjG+mnjG2;"
    "mnjB=mnjB+mnjB2;"
    "\n#endif\n"
    "AH2 "
    "mxjR=AMax3H2(AMax3H2(fR,iR,jR),kR,nR),mxjG=AMax3H2(AMax3H2(fG,iG,jG),kG,"
    "nG),mxjB=AMax3H2(AMax3H2(fB,iB,jB),kB,nB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mxjR2=AMax3H2(AMax3H2(mxjR,eR,gR),mR,oR),mxjG2=AMax3H2(AMax3H2(mxjG,eG,gG)"
    ",mG,oG),mxjB2=AMax3H2(AMax3H2(mxjB,eB,gB),mB,oB);"
    "mxjR=mxjR+mxjR2;"
    "mxjG=mxjG+mxjG2;"
    "mxjB=mxjB+mxjB2;"
    "\n#endif\n"
    "AH2 "
    "mnkR=AMin3H2(AMin3H2(gR,jR,kR),lR,oR),mnkG=AMin3H2(AMin3H2(gG,jG,kG),lG,"
    "oG),mnkB=AMin3H2(AMin3H2(gB,jB,kB),lB,oB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mnkR2=AMin3H2(AMin3H2(mnkR,fR,hR),nR,pR),mnkG2=AMin3H2(AMin3H2(mnkG,fG,hG)"
    ",nG,pG),mnkB2=AMin3H2(AMin3H2(mnkB,fB,hB),nB,pB);"
    "mnkR=mnkR+mnkR2;"
    "mnkG=mnkG+mnkG2;"
    "mnkB=mnkB+mnkB2;"
    "\n#endif\n"
    "AH2 "
    "mxkR=AMax3H2(AMax3H2(gR,jR,kR),lR,oR),mxkG=AMax3H2(AMax3H2(gG,jG,kG),lG,"
    "oG),mxkB=AMax3H2(AMax3H2(gB,jB,kB),lB,oB);"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "mxkR2=AMax3H2(AMax3H2(mxkR,fR,hR),nR,pR),mxkG2=AMax3H2(AMax3H2(mxkG,fG,hG)"
    ",nG,pG),mxkB2=AMax3H2(AMax3H2(mxkB,fB,hB),nB,pB);"
    "mxkR=mxkR+mxkR2;"
    "mxkG=mxkG+mxkG2;"
    "mxkB=mxkB+mxkB2;"
    "\n#endif\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "AH2 "
    "rcpMfR=ARcpH2(mxfR),rcpMfG=ARcpH2(mxfG),rcpMfB=ARcpH2(mxfB),rcpMgR=ARcpH2("
    "mxgR),rcpMgG=ARcpH2(mxgG),rcpMgB=ARcpH2(mxgB),rcpMjR=ARcpH2(mxjR),rcpMjG="
    "ARcpH2(mxjG),rcpMjB=ARcpH2(mxjB),rcpMkR=ARcpH2(mxkR),rcpMkG=ARcpH2(mxkG),"
    "rcpMkB=ARcpH2(mxkB);"
    "\n#else\n"
    "AH2 "
    "rcpMfR=APrxLoRcpH2(mxfR),rcpMfG=APrxLoRcpH2(mxfG),rcpMfB=APrxLoRcpH2(mxfB)"
    ",rcpMgR=APrxLoRcpH2(mxgR),rcpMgG=APrxLoRcpH2(mxgG),rcpMgB=APrxLoRcpH2("
    "mxgB),rcpMjR=APrxLoRcpH2(mxjR),rcpMjG=APrxLoRcpH2(mxjG),rcpMjB="
    "APrxLoRcpH2(mxjB),rcpMkR=APrxLoRcpH2(mxkR),rcpMkG=APrxLoRcpH2(mxkG),"
    "rcpMkB=APrxLoRcpH2(mxkB);"
    "\n#endif\n"
    "\n#ifdef CAS_BETTER_DIAGONALS\n"
    "AH2 "
    "ampfR=ASatH2(min(mnfR,AH2_(2.)-mxfR)*rcpMfR),ampfG=ASatH2(min(mnfG,AH2_(2."
    ")-mxfG)*rcpMfG),ampfB=ASatH2(min(mnfB,AH2_(2.)-mxfB)*rcpMfB),ampgR=ASatH2("
    "min(mngR,AH2_(2.)-mxgR)*rcpMgR),ampgG=ASatH2(min(mngG,AH2_(2.)-mxgG)*"
    "rcpMgG),ampgB=ASatH2(min(mngB,AH2_(2.)-mxgB)*rcpMgB),ampjR=ASatH2(min("
    "mnjR,AH2_(2.)-mxjR)*rcpMjR),ampjG=ASatH2(min(mnjG,AH2_(2.)-mxjG)*rcpMjG),"
    "ampjB=ASatH2(min(mnjB,AH2_(2.)-mxjB)*rcpMjB),ampkR=ASatH2(min(mnkR,AH2_(2."
    ")-mxkR)*rcpMkR),ampkG=ASatH2(min(mnkG,AH2_(2.)-mxkG)*rcpMkG),ampkB=ASatH2("
    "min(mnkB,AH2_(2.)-mxkB)*rcpMkB);"
    "\n#else\n"
    "AH2 "
    "ampfR=ASatH2(min(mnfR,AH2_(1.)-mxfR)*rcpMfR),ampfG=ASatH2(min(mnfG,AH2_(1."
    ")-mxfG)*rcpMfG),ampfB=ASatH2(min(mnfB,AH2_(1.)-mxfB)*rcpMfB),ampgR=ASatH2("
    "min(mngR,AH2_(1.)-mxgR)*rcpMgR),ampgG=ASatH2(min(mngG,AH2_(1.)-mxgG)*"
    "rcpMgG),ampgB=ASatH2(min(mngB,AH2_(1.)-mxgB)*rcpMgB),ampjR=ASatH2(min("
    "mnjR,AH2_(1.)-mxjR)*rcpMjR),ampjG=ASatH2(min(mnjG,AH2_(1.)-mxjG)*rcpMjG),"
    "ampjB=ASatH2(min(mnjB,AH2_(1.)-mxjB)*rcpMjB),ampkR=ASatH2(min(mnkR,AH2_(1."
    ")-mxkR)*rcpMkR),ampkG=ASatH2(min(mnkG,AH2_(1.)-mxkG)*rcpMkG),ampkB=ASatH2("
    "min(mnkB,AH2_(1.)-mxkB)*rcpMkB);"
    "\n#endif\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "ampfR=sqrt(ampfR);"
    "ampfG=sqrt(ampfG);"
    ...
    "AH1 peak=AH2_AU1(const1.y).x;"
    "AH2 "
    "wfR=ampfR*AH2_(peak),wfG=ampfG*AH2_(peak),wfB=ampfB*AH2_(peak),wgR=ampgR*"
    "AH2_(peak),wgG=ampgG*AH2_(peak),wgB=ampgB*AH2_(peak),wjR=ampjR*AH2_(peak),"
    "wjG=ampjG*AH2_(peak),wjB=ampjB*AH2_(peak),wkR=ampkR*AH2_(peak),wkG=ampkG*"
    "AH2_(peak),wkB=ampkB*AH2_(peak),s=(AH2_(1.)-ppX)*(AH2_(1.)-AH2_(ppY)),t="
    "ppX*(AH2_(1.)-AH2_(ppY)),u=(AH2_(1.)-ppX)*AH2_(ppY),v=ppX*AH2_(ppY),thinB="
    "AH2_(1./32.);"
    "\n#ifdef CAS_GO_SLOWER\n"
    ...
    "\n#ifdef CAS_GO_SLOWER\n"
    "AH2 "
    "rcpWG=ARcpH2(AH2_(2.)*qbeG+AH2_(2.)*qchG+AH2_(2.)*qinG+AH2_(2.)*qloG+qfG+"
    "qgG+qjG+qkG);"
    "\n#else\n"
    "AH2 "
    "rcpWG=APrxMedRcpH2(AH2_(2.)*qbeG+AH2_(2.)*qchG+AH2_(2.)*qinG+AH2_(2.)*"
    "qloG+qfG+qgG+qjG+qkG);"
    "\n#endif\n"
    "pixR=ASatH2((bR*qbeG+eR*qbeG+cR*qchG+hR*qchG+iR*qinG+nR*qinG+lR*qloG+oR*"
    "qloG+fR*qfG+gR*qgG+jR*qjG+kR*qkG)*rcpWG);"
    "pixG=ASatH2((bG*qbeG+eG*qbeG+cG*qchG+hG*qchG+iG*qinG+nG*qinG+lG*qloG+oG*"
    "qloG+fG*qfG+gG*qgG+jG*qjG+kG*qkG)*rcpWG);"
    "pixB=ASatH2((bB*qbeG+eB*qbeG+cB*qchG+hB*qchG+iB*qinG+nB*qinG+lB*qloG+oB*"
    "qloG+fB*qfG+gB*qgG+jB*qjG+kB*qkG)*rcpWG);"
    "\n#else\n"
    "\n#ifdef CAS_GO_SLOWER\n"
    "AH2 "
    "rcpWR=ARcpH2(AH2_(2.)*qbeR+AH2_(2.)*qchR+AH2_(2.)*qinR+AH2_(2.)*qloR+qfR+"
    "qgR+qjR+qkR),rcpWG=ARcpH2(AH2_(2.)*qbeG+AH2_(2.)*qchG+AH2_(2.)*qinG+AH2_("
    "2.)*qloG+qfG+qgG+qjG+qkG),rcpWB=ARcpH2(AH2_(2.)*qbeB+AH2_(2.)*qchB+AH2_(2."
    ")*qinB+AH2_(2.)*qloB+qfB+qgB+qjB+qkB);"
    "\n#else\n"
    "AH2 "
    "rcpWR=APrxMedRcpH2(AH2_(2.)*qbeR+AH2_(2.)*qchR+AH2_(2.)*qinR+AH2_(2.)*"
    "qloR+qfR+qgR+qjR+qkR),rcpWG=APrxMedRcpH2(AH2_(2.)*qbeG+AH2_(2.)*qchG+AH2_("
    "2.)*qinG+AH2_(2.)*qloG+qfG+qgG+qjG+qkG),rcpWB=APrxMedRcpH2(AH2_(2.)*qbeB+"
    "AH2_(2.)*qchB+AH2_(2.)*qinB+AH2_(2.)*qloB+qfB+qgB+qjB+qkB);"
    "\n#endif\n"
    "pixR=ASatH2((bR*qbeR+eR*qbeR+cR*qchR+hR*qchR+iR*qinR+nR*qinR+lR*qloR+oR*"
    "qloR+fR*qfR+gR*qgR+jR*qjR+kR*qkR)*rcpWR);"
    "pixG=ASatH2((bG*qbeG+eG*qbeG+cG*qchG+hG*qchG+iG*qinG+nG*qinG+lG*qloG+oG*"
    "qloG+fG*qfG+gG*qgG+jG*qjG+kG*qkG)*rcpWG);"
    "pixB=ASatH2((bB*qbeB+eB*qbeB+cB*qchB+hB*qchB+iB*qinB+nB*qinB+lB*qloB+oB*"
    "qloB+fB*qfB+gB*qgB+jB*qjB+kB*qkB)*rcpWB);"
    "\n#endif\n"
    "}\n"
    "#endif\n"
    "void main()"
    "{"
    "AF3 c;"
    "CasFilter(c.x,c.y,c.z,uvec2(gl_FragCoord.xy+vec2(-Const2.x,Const2.y)),"
    "Const0,Const1,false);"
    "color=vec4(c,1.);"
    "}";
