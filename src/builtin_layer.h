...
static const int FURU_AMP_TABLE_SIZE =
    256;  // should also be power of 2, it helps
...
inline void drawTaggedSurface(SDL_Surface *dst_surface,
                              AnimationInfo *anim,
                              SDL_Rect &clip) {
    anim->blendOnSurface(
        dst_surface, anim->pos.x, anim->pos.y, clip, anim->trans);
}
#endif
