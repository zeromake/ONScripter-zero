...
int main(int argc, char* argv[]) {
    ...
    // rect_height*windowScale}; SDL_SetRenderDrawColor(renderer, 0xff, 0xff,
    // 0xff, 0xff); SDL_RenderClear(renderer); auto windowSurface =
    // SDL_CreateRGBSurface(0, 800, 600, 32, 0xFF000000, 0x00FF0000, 0x0000FF00,
    // 0x000000FF);;
    renderer_w *= windowScale;
    renderer_h *= windowScale;
    auto windowSurface = SDL_CreateRGBSurfaceWithFormat(
        0, renderer_w, renderer_h, 32, SDL_PIXELFORMAT_BGRA32);
